    ...
    def resize(self, screen):
        ...
        if self._need_update and self.arrow_location != ARROW_HIDDEN:
            if self.arrow_location == ARROW_TOUCH:
                ...
                vflip = self.arrow_location == ARROW_TOP
                self.left_arrow = pictures.get_pygame_image("arrow.png", size, vflip=vflip, color=self._text_color)

                x = int(self._rect.left + self._rect.width // 4 - self.left_arrow.get_rect().width // 2)
...
class IntroWithPrintBackground(IntroBackground):
    ...
    def resize(self, screen):
        ...
        if self._need_update and self.arrow_location != ARROW_HIDDEN:
            ...
            x = int(self._rect.left + self._rect.width // 2 - self.right_arrow.get_rect().width // 2)
            if self.arrow_location == ARROW_TOP:
                y = self._rect.top + 10
            else:
...
class ChosenBackground(Background):
    ...
    def __str__(self):
        ...
        """
        return f"{self.__class__.__name__}({self._name}{self.selected})"
...
class CaptureBackground(Background):
    ...
    def resize(self, screen):
        ...
        if self._need_update:
            ...
            self.left_people = pictures.get_pygame_image("capture_left.png", size=size, color=self._text_color)
            self.right_people = pictures.get_pygame_image("capture_right.png", size=size, color=self._text_color)
    ...
    def resize(self, screen):
        ...
        if self._need_update and self.arrow_location != ARROW_HIDDEN:
            if self.arrow_location == ARROW_TOUCH:
                ...
                x = int(self._rect.left + self._rect.width * 0.70 - self.right_arrow.get_rect().width // 2)
                ...
                x = int(self._rect.left + self._rect.width * 0.75 - self.right_arrow.get_rect().width // 2)
                if self.arrow_location == ARROW_TOP:
                    y = self._rect.top + 10
                else:
                    y = int(self._rect.top + 2 * self._rect.height // 3)
            ...
            x = int(self._rect.left + self._rect.width // 2 - self.left_arrow.get_rect().width // 2)
...
class FinishedBackground(Background):
    ...
    def resize(self, screen):
        ...
        if self._need_update:
            ...
            self.left_people = pictures.get_pygame_image(
                "finished_left.png", size=left_rect.size, color=self._text_color
            )
            self.right_people = pictures.get_pygame_image(
                "finished_right.png", size=right_rect.size, color=self._text_color
            )
